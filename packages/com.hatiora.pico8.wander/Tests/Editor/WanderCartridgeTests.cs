...
using UnityEngine;
// using Hatiora.Pico8.Wander; // Uncomment if different from default

namespace Hatiora.Pico8.Wander.Tests.Editor
{
    public class WanderCartridgeTests
    {
        private WanderCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new WanderCartridge();
