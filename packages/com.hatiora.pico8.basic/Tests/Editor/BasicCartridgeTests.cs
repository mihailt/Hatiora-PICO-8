...
using UnityEngine;
// using Hatiora.Pico8.Basic; // Uncomment if different from default

namespace Hatiora.Pico8.Basic.Tests.Editor
{
    public class BasicCartridgeTests
    {
        private BasicCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new BasicCartridge();
