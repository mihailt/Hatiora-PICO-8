...
using UnityEngine;
// using Hatiora.Pico8.Api; // Uncomment if different from default

namespace Hatiora.Pico8.Api.Tests.Editor
{
    public class ApiCartridgeTests
    {
        private ApiCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new ApiCartridge();
