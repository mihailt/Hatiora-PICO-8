...
using UnityEngine;
// using Hatiora.Pico8.Launcher; // Uncomment if different from default

namespace Hatiora.Pico8.Launcher.Tests.Editor
{
    public class LauncherCartridgeTests
    {
        private LauncherCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new LauncherCartridge();
