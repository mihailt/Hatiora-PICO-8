...
using UnityEngine;
// using Hatiora.Pico8.Waves; // Uncomment if different from default

namespace Hatiora.Pico8.Waves.Tests.Editor
{
    public class WavesCartridgeTests
    {
        private WavesCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new WavesCartridge();
