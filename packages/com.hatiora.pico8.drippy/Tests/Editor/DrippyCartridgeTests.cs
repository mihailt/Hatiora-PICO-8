...
using UnityEngine;
// using Hatiora.Pico8.Drippy; // Uncomment if different from default

namespace Hatiora.Pico8.Drippy.Tests.Editor
{
    public class DrippyCartridgeTests
    {
        private DrippyCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new DrippyCartridge();
