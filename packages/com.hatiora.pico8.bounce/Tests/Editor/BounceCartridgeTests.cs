...
using UnityEngine;
// using Hatiora.Pico8.Bounce; // Uncomment if different from default

namespace Hatiora.Pico8.Bounce.Tests.Editor
{
    public class BounceCartridgeTests
    {
        private BounceCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new BounceCartridge();
