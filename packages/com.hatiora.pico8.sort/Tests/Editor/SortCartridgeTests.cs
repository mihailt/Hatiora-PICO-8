...
using UnityEngine;
// using Hatiora.Pico8.Sort; // Uncomment if different from default

namespace Hatiora.Pico8.Sort.Tests.Editor
{
    public class SortCartridgeTests
    {
        private SortCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new SortCartridge();
