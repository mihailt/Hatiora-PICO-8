...
using UnityEngine;
// using Hatiora.Pico8.Automata; // Uncomment if different from default

namespace Hatiora.Pico8.Automata.Tests.Editor
{
    public class AutomataCartridgeTests
    {
        private AutomataCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new AutomataCartridge();
