...
using UnityEngine;
// using Hatiora.Pico8.Collide; // Uncomment if different from default

namespace Hatiora.Pico8.Collide.Tests.Editor
{
    public class CollideCartridgeTests
    {
        private CollideCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new CollideCartridge();
