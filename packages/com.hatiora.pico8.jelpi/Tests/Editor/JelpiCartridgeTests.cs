...
using UnityEngine;
// using Hatiora.Pico8.Jelpi; // Uncomment if different from default

namespace Hatiora.Pico8.Jelpi.Tests.Editor
{
    public class JelpiCartridgeTests
    {
        private JelpiCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new JelpiCartridge();
