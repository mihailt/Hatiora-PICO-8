...
using UnityEngine;
// using Hatiora.Pico8.Cast; // Uncomment if different from default

namespace Hatiora.Pico8.Cast.Tests.Editor
{
    public class CastCartridgeTests
    {
        private CastCartridge _cartridge;
        private Hatiora.Pico8.Unity.Pico8Builder _builder;

        [SetUp]
        public void Setup()
        {
            _cartridge = new CastCartridge();
